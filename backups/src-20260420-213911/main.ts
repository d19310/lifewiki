import { App, Notice, Plugin, PluginManifest, TFolder } from 'obsidian';
...
import {
	DEFAULT_IDENTITY, DEFAULT_SOUL, DEFAULT_SKILLS, DEFAULT_MEMORY, DEFAULT_WIKI, DEFAULT_CHAT_PROMPT
