/**
 * URL Utilities Tests
 * Pure unit tests for URL extraction and validation
 */

import { extractURLs, isWechatURL, isValidURL } from './url-utils';
...
describe('URL Extraction', () => {
	describe('extractURLs', () => {
		...
		it('extracts URLs with special characters', () => {
			const text = '链接 https://example.com/path/name.html';
			const urls = extractURLs(text);
			expect(urls).toEqual(['https://example.com/path/name.html']);
		});
	});
});
